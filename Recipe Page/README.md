...
2. Scroll through the page to see the recipe details

3. Follow the ingredients and instructions to make the cookies

## Purpose

-Practice semantic HTML structure (<html>, <head>, <body>)
-Learn how to use headings (<h1>, <h2>)
-Practice using paragraphs, images, and lists
